...
Let's look at some performance metrics for the MTA subway network as a whole. Some of the definitions are opaque, so I'll specify where necessary.
...
Even though I include earlier data that creates a steeper downward trend in On-Time Performance and Wait Assessment, there is a clear trend between 2015 and 2018 that is mitigated on the MTA's dashboard due to their use of a 0-100% vertical axis. In other words, they present the data to tell a story of relative stability in the performance of the subway system, whereas I uncover a story of consistently decreasing performance. 

This story isn't new to anyone who has ridden the subway, but why have data publically tracked if it is misleading to those who use it? 